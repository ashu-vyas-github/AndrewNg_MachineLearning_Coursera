...
def cost_function_regularized(theta, x_data, y_data, regularization_lambda=1.0):
    ...
    hypothesis = mcc_nn_funcs.sigmoid_function(numpy.dot(x_data, theta))
    ...
    gradient = mcc_nn_funcs.gradient_function_regularized(
        theta, x_data, y_data, regularization_lambda=regularization_lambda)

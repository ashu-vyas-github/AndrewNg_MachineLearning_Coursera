...
def predict(theta1, theta2, x_data):
    ...
    input_to_hidden_layer = nnl_funcs.sigmoid_function(numpy.dot(x_data, numpy.transpose(theta1)))
    ...
    hidden_to_output = nnl_funcs.sigmoid_function(numpy.dot(input_to_hidden_layer, numpy.transpose(theta2)))
